...
[![TinyMCE](https://img.shields.io/badge/TinyMCE-8.0.1+-blue.svg)](https://www.tiny.cloud/)
...
This project is licensed under the MIT License with an Additional Attribution Clause — see the LICENSE file for details.

Bu proje MIT Lisansı (Ek Atıf Şartı ile) kapsamında lisanslanmıştır — detaylar için LICENSE dosyasına bakın.
